...
function clean_container() {
  ...
  pct exec $container -- bash -c "apt-get -y --purge autoremove && apt-get -y autoclean && bash <(curl -fsSL https://github.com/PaulHam211/ProxmoxScripts/raw/main/misc/clean.sh) && rm -rf /var/lib/apt/lists/* && apt-get update"
}
